...
def log_process(requeststart, timepoint, requestend, log_file, func_name, runtime, mem_size, startType):
    ...
    with open(log_file,"a") as f:
        ...
        f.write("Function-Name:{}, startType:{}, Runtime:{}, MemorySize:{}, ColdStart-Duration:{}, Function-Duration:{}, e2e-Duration:{}".format(func_name, runtime, startType, mem_size, initDuration, duration, e2eDuration))
        f.write("\n")
